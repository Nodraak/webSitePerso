...
/*=== LIST TABLE DATA ===*/
	...
	$fileAll = scandir('/home/adur/Music/music/');
	exec('exiftool /home/adur/Music/music/* | grep Title', $title);
	exec('exiftool /home/adur/Music/music/* | grep Artist', $artist);
	exec('exiftool /home/adur/Music/music/* | grep Album', $album);
